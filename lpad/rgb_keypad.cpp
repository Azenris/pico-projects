...
void RGBKeypad::set_color(u8 x, u8 y, u8 r, u8 g, u8 b) {
...
void RGBKeypad::set_color(u8 r, u8 g, u8 b) {
...
void RGBKeypad::set_color(u8 index, u8 r, u8 g, u8 b) {
...
void RGBKeypad::set_color(u8 index, u8 r, u8 g, u8 b, f32 brightness) {
    if(index < 0 || index >= NUM_PADS)
        return;
...
void RGBKeypad::set_color(Color color) {
    for(i32 index = 0; index < NUM_PADS; ++index) {
        i32 offset = index * 4;

        ledData[offset + 1] = color.b;
        ledData[offset + 2] = color.g;
        ledData[offset + 3] = color.r;
    }
}

void RGBKeypad::set_color(Color color, f32 brightness) {
    for(i32 index = 0; index < NUM_PADS; ++index) {
        i32 offset = index * 4;
...
void RGBKeypad::set_color(u8 index, Color color) {
    set_color(index, color.r, color.g, color.b);
}

void RGBKeypad::set_color(u8 index, Color color, f32 brightness) {
    set_color(index, color.r, color.g, color.b, brightness);
}

...
struct RGBKeypad {
    ...
    f32 get_brightness(u8 index);

    void set_color(u8 r, u8 g, u8 b);
    void set_color(u8 x, u8 y, u8 r, u8 g, u8 b);
    void set_color(u8 index, u8 r, u8 g, u8 b);
    void set_color(u8 index, u8 r, u8 g, u8 b, f32 brightness);
    void set_color(Color color);
    void set_color(Color color, f32 brightness);
    void set_color(u8 index, Color color);
    void set_color(u8 index, Color color, f32 brightness);
